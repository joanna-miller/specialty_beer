...
50.times do |index|
  product = Product.create!(name: Faker::Beer.unique.name, brand: Faker::Beer.brand, country_of_origin: Faker::Address.country, cost: Faker::Commerce.price(range: 7..25.0))
  5.times do |index|
